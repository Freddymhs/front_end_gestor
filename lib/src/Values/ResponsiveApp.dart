...
import 'package:front_end_gestor/Util/EdgeInsetsApp.dart';
...
class ResponsiveApp {
  ...
  get width => _mediaQueryData?.size.height;
  get height => _mediaQueryData?.size.width;
  get backgroundColor => Colors.grey[900];
}
