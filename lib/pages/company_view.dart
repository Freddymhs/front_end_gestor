...
class CompanyView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final companyUsersData = useQuery(QueryOptions(
      ...
      variables: {'companyId': userData.companyId},
    ));
        ...
        fToast.showToast(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: Colors.blue, // Adjust for success or error toast
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.check,
                    color: Colors.white), // Optional icon for success
                SizedBox(width: 8.0),
                Text(
                  successLabel, // Customize the message
          ...
          positionedToastBuilder: (context, child) {
            return Positioned(
              top: 60.0, // Adjust position as desired
              right: 50.0, // Adjust position as desired
              child: child,
            );
          },
        );
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text('${user['enabled'] ? 'desactivar' : 'activar'} '),
            ),
          ],
        );
      },
